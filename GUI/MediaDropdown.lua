...
local SPEAKER_TEXTURE = "Interface\\AddOns\\MidnightFocusInterrupt\\GUI\\Assets\\Media_Play.png" -- Interface\\Common\\VoiceChat-Speaker
local SPEAKER_ON_TEXTURE = "Interface\\AddOns\\MidnightFocusInterrupt\\GUI\\Assets\\Media_Play.png" -- Interface\\Common\\VoiceChat-On
